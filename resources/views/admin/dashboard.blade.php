        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="btn-group-vertical w-100">
              ...
              <a href="{{ route('admin.dokter.index') }}" class="btn btn-outline-success btn-sm">
                <i class="fas fa-user-md"></i> Kelola Dokter
              </a>
              <a href="{{ route('admin.pasien.index') }}" class="btn btn-outline-warning btn-sm">
                <i class="fas fa-users"></i> Kelola Pasien
              </a>
              <a href="{{ route('admin.obat.index') }}" class="btn btn-outline-danger btn-sm">
